...
const MainSection = (props) => {
    return (
        <div className="mainSection">
            <MenuBar menuItems={props.menuItemList} scrolled={(props.scrollPos > 400 ? true : false)} />
            <MobileMenu menuItems={props.menuItemList} />
            <SideCard img={props.profileImg} profileName={props.profileName} socialLinks={props.socialLinks} />
            <div name="projects" className="teszt">
